...
public class GoogleOAuthSession {
    ...
    public GoogleOAuthSession(GoogleIdentity identity, String accessToken, String refreshToken, Instant expiresAt, List<String> scopes) {
    ...
    public GoogleIdentity getIdentity() {
        return identity;
    }
